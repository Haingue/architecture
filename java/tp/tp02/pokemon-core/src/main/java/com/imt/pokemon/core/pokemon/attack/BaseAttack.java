...
public class BaseAttack implements PokemonAttack {
    ...
    protected BaseAttack(int priority, String name, boolean isPhysical, PokemonType type, int basePower, int baseAccuracy, int basePowerPoint, PokemonEffect targetEffect, double targetEffectSuccessRate, PokemonEffect selfEffect, double selfEffectSuccessRate) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BaseAttack attack)
