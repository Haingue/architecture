...
Tout d’abord assurez-vous que la dépendance Thymeleaf est bien dans votre pom.xml sans ça, vous n’aurais pas accès aux fonctionnalités de ce moteur de template.
```xml
<dependency>
...
Puis créez le contrôler permettant de générer cette vue.
